...
public class NumberLineGameCell extends GameCell {
	...
	public void render(Context context,	GameState game, SafeHtmlBuilder sb) {
		...
		sb.appendEscaped(game.getName() + "       (" + game.getPlayerCount() + "/" + game.getMaxNumberOfPlayers() + " Spieler, " + ((NumberLineGameState) game).getMaxItems() + " Runden)");
