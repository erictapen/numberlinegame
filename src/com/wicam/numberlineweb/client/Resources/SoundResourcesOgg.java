...
public interface SoundResourcesOgg extends ClientBundle, SoundResources{
	
    public static final SoundResourcesOgg INSTANCE = 
            GWT.create(SoundResourcesOgg.class);
