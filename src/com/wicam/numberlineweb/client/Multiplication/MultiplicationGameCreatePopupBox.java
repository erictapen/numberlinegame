...
public class MultiplicationGameCreatePopupBox extends com.wicam.numberlineweb.client.GameCreatePopupBox {

	
	ListBox roundCount = new ListBox();
	ListBox npcsCount = new ListBox();
	
	public MultiplicationGameCreatePopupBox (String msg, String def) {
