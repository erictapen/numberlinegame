...
public class MathAssessmentDetailView extends AbsolutePanel {
	...
	public void init(MathAssessmentController controller, int numberOfPlayers){
	...
	public void drawAnwers(ArrayList<MathAssessmentAnswer> answers) {
		...
		for (final MathAssessmentAnswer answer : answers) {
