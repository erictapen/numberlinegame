...
class MathAssessmentCloseQuestion extends DialogBox {
	
	MathAssessmentCoordinator coord;

	public MathAssessmentCloseQuestion(MathAssessmentCoordinator coord) {
		...
		ok.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				MathAssessmentCloseQuestion.this.hide();
				MathAssessmentCloseQuestion.this.coord.handleAssessmentAbortion();
			}
		});
