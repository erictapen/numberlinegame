...
public class BuddyNumberGameCell extends GameCell {
	...
	public void render(Context context,	GameState game, SafeHtmlBuilder sb) {
		...
		sb.appendEscaped(game.getName() + "       (" + game.getPlayerCount() + "/" + game.getMaxNumberOfPlayers() + " Spieler, " + ((BuddyNumberGameState) game).getRound() + " Runden)");
