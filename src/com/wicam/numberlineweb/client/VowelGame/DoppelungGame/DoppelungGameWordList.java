...
public class DoppelungGameWordList {
	...
	private static void shuffle(ArrayList<VowelGameWord> wordList) { 
		for(int i = wordList.size(); i > 1; i--) { 
			swap(wordList, i - 1, Random.nextInt(i));  
		}
	}

	
	private static void swap(ArrayList<VowelGameWord> wordList, int a, int b) {
		VowelGameWord t = wordList.get(a);
