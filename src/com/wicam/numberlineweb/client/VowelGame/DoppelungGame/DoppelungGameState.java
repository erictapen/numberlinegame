...
public class DoppelungGameState extends GameState {
	...
	private VowelGameWord curWord = new VowelGameWord();
	...
	public void setNextWord(VowelGameWord word){
		curWord = word;
	}
	...
	public void setCurWord(VowelGameWord curWord) {
		this.curWord = curWord;
	}

	public VowelGameWord getCurWord() {
		return curWord;
	}
