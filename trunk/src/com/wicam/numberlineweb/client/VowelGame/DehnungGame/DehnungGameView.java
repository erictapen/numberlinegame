...
public class DehnungGameView extends DoppelungGameView {
	...
	protected void setExplanationText(){
		explanationText.setHTML("<div style='padding:5px 20px;font-size:25px'><b>Dehnungspiel - Erklärung</b></div>" +
				...
				"In diesem Spiel geht es um das Dehnungs-h. Wenn du nach einem langen Vokal „l, m, n, oder r“ hörst, dann wird der Vokal meistens mit einem Dehnungs- h gedehnt. Wenn du zum Beispiel das Wort „dehnen“ hörst, dann schreibt man nach dem „e“ ein „h“, weil der Vokal „e“ lang ist und weil nach dem langen „e“ ein „n“ folgt (dehnen). " + 
				"Wenn nach einem langen Vokal weder „l“ noch „m“ noch „n“ noch „r“ folgen, dann muss man meistens kein Dehnungs- h schreiben. Wenn du zum Beispiel das Wort „Vater“ hörst, dann musst du kein „h“ schreiben, weil nach dem langen „a“ ein „t“ folgt (Vater). "+
