...
public class WordFamilyGameCell extends GameCell {
	...
	public void render(Context context,	GameState game, SafeHtmlBuilder sb) {
		...
		sb.appendEscaped(game.getName() + "       (" + game.getPlayerCount() + "/" + game.getMaxNumberOfPlayers() + " Spieler, " + ((WordFamilyGameState) game).getRound() + " Runden)");
