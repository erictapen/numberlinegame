...
public class WordFamilyCollection implements IsSerializable {
	...
	public WordFamilyCollection(boolean hard) {
		...
		if (hard) {
			...
			wordCollection.add(new WordFamily("brennen", new ArrayList<String>(Arrays.asList("verbrennen","verbrannt","ausgebrannt"))));
			...
			wordCollection.add(new WordFamily("füllen", new ArrayList<String>(Arrays.asList("ausfüllen","Fülle","gefüllt","Füllgewicht"))));
			wordCollection.add(new WordFamily("Glück", new ArrayList<String>(Arrays.asList("glücklich","geglückt","Glücksspiel","verunglücken"))));
			wordCollection.add(new WordFamily("hell", new ArrayList<String>(Arrays.asList("heller","Helligkeit","erhellt"))));
			wordCollection.add(new WordFamily("Herr", new ArrayList<String>(Arrays.asList("herrlich","Herrenhaus","beherrschen"))));
			wordCollection.add(new WordFamily("hoffen", new ArrayList<String>(Arrays.asList("Hoffnung","hofft","erhoffen","hoffentlich"))));
			wordCollection.add(new WordFamily("irren", new ArrayList<String>(Arrays.asList("Irrtum","verirren","geirrt"))));
			...
			wordCollection.add(new WordFamily("kommen", new ArrayList<String>(Arrays.asList("ankommen","kommt","gekommen","vorkommen"))));
			wordCollection.add(new WordFamily("lassen", new ArrayList<String>(Arrays.asList("Entlassung","hereinlassen","verlassen","lässt"))));
			...
			wordCollection.add(new WordFamily("packen", new ArrayList<String>(Arrays.asList("Päckchen","eingepackt","Packungsbeilage"))));
			wordCollection.add(new WordFamily("passen", new ArrayList<String>(Arrays.asList("aufpassen","verpasst","passend"))));
			wordCollection.add(new WordFamily("rennen", new ArrayList<String>(Arrays.asList("Pferderennen","Rennfahrer","gerannt","rennt","Rennbahn"))));
			...
			wordCollection.add(new WordFamily("rollen", new ArrayList<String>(Arrays.asList("Rolltreppe","rollt","gerollt","Rolle"))));
			wordCollection.add(new WordFamily("sammeln", new ArrayList<String>(Arrays.asList("Versammlung","gesammelt","versammelt"))));
			...
			wordCollection.add(new WordFamily("spannen", new ArrayList<String>(Arrays.asList("gespannt","Spannung","verspannt","ausspannen"))));
			wordCollection.add(new WordFamily("Sperre", new ArrayList<String>(Arrays.asList("versperren","sperrig","gesperrt"))));
			wordCollection.add(new WordFamily("Stelle", new ArrayList<String>(Arrays.asList("verstellen","gestellt","Ausstellung","aufstellen"))));
			wordCollection.add(new WordFamily("stoppen", new ArrayList<String>(Arrays.asList("Stoppschild","gestoppt"))));
			wordCollection.add(new WordFamily("stumm", new ArrayList<String>(Arrays.asList("stummer","verstummen","verstummt"))));
			...
			wordCollection.add(new WordFamily("Tritt", new ArrayList<String>(Arrays.asList("Austritt","Eintritt","Trittbrett"))));
			wordCollection.add(new WordFamily("trocken", new ArrayList<String>(Arrays.asList("vertrocknet","Trockenheit","Wäschetrockner"))));
			wordCollection.add(new WordFamily("verwirren", new ArrayList<String>(Arrays.asList("Verwirrung","verwirrend","verwirrt"))));
			wordCollection.add(new WordFamily("voll", new ArrayList<String>(Arrays.asList("mühevoll","verständnisvoll","liebevoll","völlig"))));
			wordCollection.add(new WordFamily("Wasser", new ArrayList<String>(Arrays.asList("Wasserquelle","bewässern"))));
			wordCollection.add(new WordFamily("wecken", new ArrayList<String>(Arrays.asList("aufwecken","Radiowecker","aufgeweckt"))));
			wordCollection.add(new WordFamily("Wette", new ArrayList<String>(Arrays.asList("Pferdewette","gewettet","Wetteinsatz"))));
			wordCollection.add(new WordFamily("Wetter", new ArrayList<String>(Arrays.asList("Wetterbericht","gewettert","Wetterfrosch"))));
			...
			wordCollection.add(new WordFamily("zerren", new ArrayList<String>(Arrays.asList("Zerrung","verzerrt","gezerrt"))));
		} else {
			wordCollection.add(new WordFamily("Ball", new ArrayList<String>(Arrays.asList("Abschlussball","Bälle"))));
			wordCollection.add(new WordFamily("beginnen", new ArrayList<String>(Arrays.asList("Beginn","begonnen"))));
			wordCollection.add(new WordFamily("besser", new ArrayList<String>(Arrays.asList("verbessern","gebessert","Besserung"))));
