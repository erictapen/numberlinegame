...
public class WordSetCollection implements IsSerializable {
	...
	public WordSetCollection() {
		...
		wordSetCollection.add(new WordSet("mess", new ArrayList<String>(Arrays.asList("abmessen","gemessen","Messbecher")), ""));
		...
		wordSetCollection.add(new WordSet("renn", new ArrayList<String>(Arrays.asList("Pferderennen","Rennfahrer","rennt","verrennen")), ""));
		wordSetCollection.add(new WordSet("riss", new ArrayList<String>(Arrays.asList("ausgerissen","rissfest","zerrissen","Riss")), ""));
		wordSetCollection.add(new WordSet("roll", new ArrayList<String>(Arrays.asList("Rolltreppe","rollt","gerollt","Rolle")), ""));
		wordSetCollection.add(new WordSet("rück", new ArrayList<String>(Arrays.asList("rückwärts","Rücken","verrücken")), ""));
		wordSetCollection.add(new WordSet("schaff", new ArrayList<String>(Arrays.asList("anschaffen","geschafft")), ""));
