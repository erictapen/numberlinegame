...
public class OverTenGameCreatePopupBox extends com.wicam.numberlineweb.client.GameCreatePopupBox {

	
	ListBox roundCount = new ListBox();
	ListBox npcsCount = new ListBox();
	
	public OverTenGameCreatePopupBox (String msg, String def) {
