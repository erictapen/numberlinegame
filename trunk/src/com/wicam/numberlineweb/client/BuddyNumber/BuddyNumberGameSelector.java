...
public class BuddyNumberGameSelector extends GameSelector {

	protected final CellList<GameState> cellList = new CellList<GameState>(new BuddyNumberGameCell(),keyProvider);
	protected final BuddyNumberGameCreatePopupBox gamePopUp = new BuddyNumberGameCreatePopupBox("Neues Spiel erstellen", "Mein Spiel");

	public BuddyNumberGameSelector(BuddyNumberGameCoordinator coordinator) {
		super(coordinator);
			...
			public void onClick(ClickEvent event) {
				...
				if (!gamePopUp.hasClickHandler()) gamePopUp.addClickHandler(new ClickHandler() {
					...
					public void onClick(ClickEvent event) {
						...
						BuddyNumberGameState gameState = new BuddyNumberGameState();
						...
						BuddyNumberGameSelector.this.coordinator.openGame(gameState);
						gamePopUp.hide();
